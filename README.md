...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/homebase-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15460&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/homebase-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `homebase` can be installed with:

```
conda install homebase
```

It is possible to list all of the versions of `homebase` available on your platform with:
